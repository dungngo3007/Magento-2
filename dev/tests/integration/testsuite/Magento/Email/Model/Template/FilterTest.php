    ...
    public function transDirectiveDataProvider()
    {
        return [
            ...
            'capture escaped double-quotes inside text' => [
                '{{trans "index \"tested\" world!"}}',
                [],
                'index &quot;tested&quot; world!',
            ],
            'capture escaped single-quotes inside text' => [
                "{{trans 'index \\'tested\\' world!'|escape}}",
                [],
                "index &#039;tested&#039; world!",
            ],
            'filter with params' => [
                "{{trans 'index \\'tested\\' world!'|escape:html}}",
                [],
                "index &#039;tested&#039; world!",
            ],
            'basic var' => [
                '{{trans "index %adjective world!" adjective="tested"}}',
                [],
                'index tested world!',
            ],
            'auto-escaped output' => [
                '{{trans "index %adjective <strong>world</strong>!" adjective="<em>bad</em>"}}',
                [],
                'index &lt;em&gt;bad&lt;/em&gt; &lt;strong&gt;world&lt;/strong&gt;!',
            ],
            'unescaped modifier' => [
                '{{trans "index %adjective <strong>world</strong>!" adjective="<em>bad</em>"|raw}}',
                [],
                'index <em>bad</em> <strong>world</strong>!',
            ],
            'variable replacement' => [
                '{{trans "index %adjective world!" adjective="$mood"}}',
                [],
                'index happy world!',
                [
                    'mood' => 'happy'
