...
class FilterApplierTest extends TestCase
{
    ...
    public function arrayUseCaseProvider()
    {
        ...
        return [
            ...
            'standard usage' => [['escape', 'nl2br'], $standardInput, 'index <br />' . "\n" . ' &amp;world!'],
            'single usage' => [['escape'], $standardInput, 'index ' . "\n" . ' &amp;world!'],
            'params' => [
            ...
            'mixed filters' => [['', false, 'escape', 0, null], $standardInput, 'index ' . "\n" . ' &amp;world!'],
        ];
    }
    ...
    public function rawUseCaseProvider()
    {
        ...
        return [
            ...
            'standard usage' => ['|escape|nl2br', $standardInput, 'index <br />' . "\n" . ' &amp;world!'],
            'single usage' => ['|escape', $standardInput, 'index ' . "\n" . ' &amp;world!'],
            'default filters' => ['', $standardInput, 'index ' . "\n" . ' &amp;world!'],
